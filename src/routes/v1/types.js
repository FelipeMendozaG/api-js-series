...
const {get_all,get_ubication, get_document, get_debtor, get_sale_organization, get_center, get_channel, get_center_charity, get_type_contact} = require('../../controllers/typeController');
